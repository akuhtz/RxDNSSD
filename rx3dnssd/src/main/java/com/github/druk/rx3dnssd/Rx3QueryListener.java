...
class Rx3QueryListener implements QueryListener {
    ...
    Rx3QueryListener(FlowableEmitter<? super BonjourService> emitter, BonjourService.Builder builder, boolean completable) {
